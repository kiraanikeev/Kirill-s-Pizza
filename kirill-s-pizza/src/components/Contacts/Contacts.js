  ...
  setPopupContscts(true)
    ...
    return (
        <div className={styles.main}>
            ...
            <span className={styles.subTitle}>You can find us by the contacts provided or send us a message using the form below</span>
          ...
          <button type="submit" className={styles.button}>Send</button>
            ...
            <ul>
              ...
              <li className={styles.contact}>
              <span><img src={phone}/> +7995330*009</span>
              </li>
              <li className={styles.contact}>
              <span><img src={email}/> kiraanikeev@mail.ru</span>
              </li>
            </ul>
